...
#[no_mangle]
pub extern "system" fn librustzcash_sapling_verification_ctx_init() -> *mut SaplingVerificationContext {
...
//) -> bool {
#[test]
fn test_sapling_output_proof() {
    let esk: [u8; 32] = [0xA1, 0xA2, 0xE, 0xA5, 0x47, 0x4F, 0x32, 0xF8, 0x3C, 0xEB, 0x27, 0x84, 0x1B, 0xF1, 0x9F, 0x99, 0xA4, 0xC7, 0xA9, 0x7C, 0x2B, 0x6B, 0xFD, 0x3F, 0x3A, 0x11, 0x1F, 0xD2, 0x57, 0x15, 0x20, 0x1];
    let diversifier: [u8; 11] = [0xC5, 0xB3, 0x3C, 0xA3, 0x7A, 0x7D, 0xDD, 0xCA, 0x6A, 0xED, 0x30];
    let pk_d: [u8; 32] = [0x31, 0xA6, 0xCB, 0xD3, 0xE9, 0x11, 0x1B, 0xAD, 0xEE, 0x15, 0x15, 0x80, 0x24, 0x6D, 0xF5, 0x77, 0x65, 0xAD, 0xC4, 0x9, 0x75, 0x87, 0xA3, 0x9D, 0x54, 0x66, 0xA7, 0xC1, 0x31, 0xBF, 0x4E, 0x21];
    let rcm: [u8; 32] = [0x61, 0x77, 0x33, 0xA5, 0x2A, 0x1C, 0xF4, 0x59, 0xA8, 0xCE, 0x9F, 0xE4, 0xB4, 0x78, 0x3B, 0xE2, 0xDF, 0x74, 0xAB, 0x2A, 0xE3, 0x43, 0xED, 0x1B, 0x35, 0xF7, 0x71, 0x19, 0xAD, 0x5E, 0x2E, 0xE];
    let value: uint64_t = 50;
    let mut cv: [u8; 32] = [0; 32];
    let mut rk: [u8; 32] = [0; 32];
    let mut proof: [u8; 192] = [0; 192];

    let spend_path = Path::new("/Users/tron/CLionProjects/librustzcash/sapling-output.params");
    let output_path = Path::new("/Users/tron/CLionProjects/librustzcash/sapling-spend.params");
    init_params(spend_path, output_path);

    let mut ctx = librustzcash_sapling_proving_ctx_init();
    let result = librustzcash_sapling_output_proof(ctx, &esk, &diversifier, &pk_d, &rcm, value, &mut cv, &mut proof);
...
#[test]
fn test_sapling_spend_proof(){
    let ak:[u8;32] = [0xc3,0x86,0x11,0x5a,0xf2,0x54,0xfc,0xa3,0x9b,0x09,0x5c,0x68,0x1f,0xab,0xe9,0xc2,0x83,0x14,0x95,0x31,0x7c,0xed,0x4c,0xca,0x22,0x9f,0x3d,0x4e,0x50,0xa1,0x83,0x5f];
    let nsk:[u8;32] = [0x8d,0xd4,0x32,0x2a,0x78,0x7d,0x1a,0xaa,0x7d,0xcc,0xab,0x16,0x91,0x6a,0x6d,0xdc,0x29,0xb7,0x2a,0x32,0x8a,0x79,0x3a,0xbc,0x0c,0x79,0x21,0x67,0xc2,0x29,0x54,0x0b];
    let d:[u8;11] = [0x3e,0x0e,0xaf,0x8f,0xb2,0x5e,0xb7,0x10,0x86,0xc4,0xe9];
    let rcm:[u8;32] = [0xed,0xc8,0xe2,0x43,0xae,0xe7,0x22,0xe4,0xdf,0x56,0x2d,0x61,0x01,0xbf,0x5d,0x4e,0x8e,0x85,0xd3,0x99,0xeb,0x37,0xb9,0xee,0x7b,0x76,0x1f,0x89,0x0a,0xdb,0x96,0x06];
    let ar:[u8;32] = [0xf2,0xa3,0x04,0x7c,0x59,0x25,0xdb,0xb5,0x14,0xca,0xbb,0x79,0xb6,0xb4,0x31,0x6a,0xee,0x7d,0xee,0xcf,0xbd,0x5a,0xe7,0x08,0xbb,0x7c,0xf7,0x0a,0x52,0x8d,0x2d,0x00];
    let anchor:[u8;32] = [0x37,0x61,0x37,0x38,0x61,0x35,0x66,0x36,0x38,0x63,0x30,0x65,0x39,0x32,0x30,0x33,0x34,0x38,0x32,0x65,0x39,0x64,0x32,0x30,0x34,0x34,0x32,0x35,0x34,0x32,0x36,0x30];
    let witness:[u8;1065] = [];
    let mut cv:[u8;32] = [0;32];
    let mut rk:[u8;32] = [0;32];
    let mut proof:[u8;192] = [0;192];
    ...
    let mut ctx = librustzcash_sapling_proving_ctx_init();
    let result = librustzcash_sapling_spend_proof(ctx,&ak,&nsk,&d,&rcm,&ar,1000,&anchor,&witness,&mut cv,&mut rk,&mut proof);
    println!("result is {:?}", result);
    librustzcash_sapling_proving_ctx_free(ctx);
}
